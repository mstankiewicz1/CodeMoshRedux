...
describe("bugsSlice", () => {
  ...
  describe("loading bugs", () => {
    description("if the bugs exist in the casch", () => {
    ...
    description("if the bugs don't exist in the casch", () => {
  ...
  it("should add the bug to the store if it save to the server", async () => {
    const bug = { description: 'a' };
